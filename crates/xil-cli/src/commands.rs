...
pub const COMMANDS: &[CommandSpec] = &[
    ...
    cmd!(native crate::cmd::cues::run, "cues", "xil_pipeline.XILP006_cues_ingester", "cues sheet ingestion", Pipeline),
    cmd!(native crate::cmd::produce::run, "produce", "xil_pipeline.XILP002_producer", "voice stem generation", Pipeline),
    cmd!(native crate::cmd::assemble::run, "assemble", "xil_pipeline.XILP003_audio_assembly", "master audio assembly", Pipeline),
    cmd!(native crate::cmd::studio_onboard::run, "studio-onboard", "xil_pipeline.XILP004_studio_onboard", "ElevenLabs Studio project onboarding", Pipeline),
    cmd!(native crate::cmd::daw::run, "daw", "xil_pipeline.XILP005_daw_export", "DAW layer export", Pipeline),
    ...
    cmd!(native crate::cmd::import::run, "import", "xil_pipeline.XILP010_studio_import", "Studio export import", Pipeline),
    cmd!(native crate::cmd::regen::run, "regen", "xil_pipeline.XILP009_script_regenerator", "script regeneration", Pipeline),
    cmd!(native crate::cmd::master::run, "master", "xil_pipeline.XILP011_master_export", "final master MP3 export", Pipeline),
    cmd!(native crate::cmd::publish::run, "publish", "xil_pipeline.XILP012_publish", "social media post draft generator", Pipeline),
    cmd!(native crate::cmd::voices::run, "voices", "xil_pipeline.XILU001_discover_voices_T2S", "voice discovery", Utility, "(before parse/produce)"),
    ...
    cmd!(native crate::cmd::sfx::run, "sfx", "xil_pipeline.XILU002_generate_SFX", "standalone SFX generation", Utility, "(after cues/parse)"),
    cmd!(native crate::cmd::sample::run, "sample", "xil_pipeline.XILU004_sample_voices_T2S", "voice sample generation", Utility, "(after voices/cast config)"),
    ...
    cmd!(native crate::cmd::stem_verify::run, "stem-verify", "xil_pipeline.XILU015_stem_verify", "scan stems folder → JSON report with file attributes and optional Whisper transcripts", Utility, "(after produce / import)"),
    cmd!(native crate::cmd::stem_compare::run, "stem-compare", "xil_pipeline.XILU016_stem_compare", "cross-reference a stem-verify transcript report against the parsed script", Utility, "(after stem-verify)"),
