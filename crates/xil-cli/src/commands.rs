...
pub const COMMANDS: &[CommandSpec] = &[
    ...
    cmd!("migrate", "xil_pipeline.XILP007_stem_migrator", "stem migration", Pipeline),
    cmd!("cleanup", "xil_pipeline.XILP008_stale_stem_cleanup", "stale stem cleanup", Pipeline),
    cmd!("import", "xil_pipeline.XILP010_studio_import", "Studio export import", Pipeline),
    cmd!("regen", "xil_pipeline.XILP009_script_regenerator", "script regeneration", Pipeline),
    ...
    cmd!("csv-join", "xil_pipeline.XILU003_csv_sfx_join", "CSV + SFX/cast annotation join", Utility, "(after parse)"),
